    ...
    return (
      <div>
        ...
        <Card title="图形按钮" className="single-button">
          ...
          <Button type="danger" icon="delete">按钮1</Button>
          <Button type="dashed" icon="edit">按钮1</Button>
          <Button shape="circle" icon="search"></Button>
        </Card>
        <Card title="loading按钮" className="single-button">
          <Button type="primary" loading={this.state.loading}>按钮1</Button>
          <Button shape="circle" loading={this.state.loading}></Button>
          <Button type="danger" onClick={this.handleTurnOn} loading={this.state.loading}>点击加载</Button>
